module Termbox2.Bindings.Hs.Internal.Key
  ( Tb_key
      ( Tb_key,
        TB_KEY_ARROW_DOWN,
        TB_KEY_ARROW_LEFT,
...
instance Show Tb_key where
  show = \case
    ...
    TB_KEY_CTRL_H -> "TB_KEY_CTRL_H"
    TB_KEY_CTRL_I -> "TB_KEY_CTRL_I"
    TB_KEY_CTRL_J -> "TB_KEY_CTRL_J"
    TB_KEY_CTRL_K -> "TB_KEY_CTRL_K"
    TB_KEY_CTRL_L -> "TB_KEY_CTRL_L"
    TB_KEY_CTRL_LSQ_BRACKET -> "TB_KEY_CTRL_LSQ_BRACKET"
    TB_KEY_CTRL_M -> "TB_KEY_CTRL_M"
    ...
    TB_KEY_CTRL_RSQ_BRACKET -> "TB_KEY_CTRL_RSQ_BRACKET"
    TB_KEY_CTRL_S -> "TB_KEY_CTRL_S"
    TB_KEY_CTRL_SLASH -> "TB_KEY_CTRL_SLASH"
    TB_KEY_CTRL_T -> "TB_KEY_CTRL_T"
    TB_KEY_CTRL_TILDE -> "TB_KEY_CTRL_TILDE"
    TB_KEY_CTRL_U -> "TB_KEY_CTRL_U"
    TB_KEY_CTRL_UNDERSCORE -> "TB_KEY_CTRL_UNDERSCORE"
